      ...
      <div className="max-w-md w-full glass-card p-8 rounded-2xl shadow-xl space-y-8 animate-fade-in-up">
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-gray-600">
            Sign in to manage university verification
          </p>
        </div>
        ...
        <div className="text-center mt-4">
          <p className="text-sm text-gray-600">
            New administrator?{' '}
            <Link to="/admin/register" className="font-medium text-blue-600 hover:text-blue-500 transition-colors duration-300">
